...
export default function ModuleIndex() {
    ...
    const columns: Column<any>[] = [
        ...
        },
        {
            id: 'actions',
            header: 'Actions',
            cell: (item) => (<BaseAction url="backoffice.master.module.show" id={item.id} setId={setId} onDelete={onDelete} />),
            sortable: false
        }
    ];
    ...
    const fetchData = async (params: Record<string, any>) => {
        const response = await axios.get<Base<any[]>>(
            route('backoffice.master.module.fetch', params)
        );
        ...
        <>
            ...
            <div className="flex justify-between" >
                ...
                <div className="flex gap-4" >
                    <Link href={route('backoffice.master.module.create')} >
                        <Button>
                            <IconPlus />
                            Add Data
                        </Button>
