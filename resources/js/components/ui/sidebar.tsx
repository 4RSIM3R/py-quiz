...
const nav = tv({
  base: [
    ...
    "group-has-data-[sidebar-intent=default]/sidebar-root:border-b group-has-data-[sidebar-intent=fleet]/sidebar-root:border-b group-has-data-[sidebar-intent=default]/sidebar-root:bg-white",
  ],
  variants: {
    isSticky: {
